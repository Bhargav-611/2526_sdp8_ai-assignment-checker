...
const TeacherUploadStudentAnswer = ({ onNavigate }) => {
        ...
        <form onSubmit={handleSubmit} className="question-form">
              ...
              >
                ...
                {questions.map((question) => (
                  <option key={question.id} value={question.id}>
                    Q{question.id}: {question.question.substring(0, 60)}... (Max: {question.max_mark} marks)
                  </option>
                ))}
              </select>
            )}
          ...
          {selectedQuestion && (
            <div className="question-meta">
              ...
              <p><strong>Model Answer:</strong> {selectedQuestion.answer}</p>
            </div>
          )}
          ...
          <button
            ...
            disabled={isSubmitting || loadingQuestions || loadingStudents}
          >
