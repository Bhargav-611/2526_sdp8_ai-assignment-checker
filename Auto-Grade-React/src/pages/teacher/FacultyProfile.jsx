...
const FacultyProfile = () => {
    ...
    const displayName = user?.name || [user?.firstName, user?.lastName].filter(Boolean).join(' ') || 'Faculty';
    ...
    const fields = [
        ...
        { label: 'Experience', value: user?.experienceYears ? `${user.experienceYears} years` : null, icon: '🗓️' },
        { label: 'Role', value: 'Faculty / Teacher', icon: '🔖' },
            ...
            <motion.div className="question-card"
                ...
                <div className="profile-hero">
                    ...
                    <div className="profile-hero-info">
                        <h2>{displayName}</h2>
                        <p className="profile-role-tag">🎓 Faculty / Teacher</p>
